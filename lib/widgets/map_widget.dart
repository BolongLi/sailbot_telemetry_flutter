...
class MapState {
  ...
  final TapPosition? mapPressPosition;  // Define TapPosition according to your data type
  final LatLng? mapPressLatLng;

  MapState({this.showPathButton = false, this.mapPressPosition, this.mapPressLatLng});
...
class MapStateNotifier extends StateNotifier<MapState> {
  ...
  void setTapDetails(TapPosition position, LatLng latLng) {
    state = state.copyWith(showPathButton: true, mapPressPosition: position, mapPressLatLng: latLng);
  }

  void resetTapDetails() {
    state = state.copyWith(showPathButton: false, mapPressPosition: null, mapPressLatLng: null);
  }
}
    ...
    return FlutterMap(
      options: MapOptions(
        ...
        onLongPress: (tapPosition, latlng) {
          ref.read(mapStateProvider.notifier).setTapDetails(tapPosition, latlng);
        },
